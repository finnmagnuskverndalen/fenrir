  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '0 16px 20px', borderBottom: '1px solid #1f1f1f' }}>
        ...
        <div style={{ color: '#444', fontSize: 10, marginTop: 2 }}>Network Security Scanner</div>
      </div>
      ...
      <div style={{ padding: '12px 16px', borderTop: '1px solid #1f1f1f', display: 'flex', alignItems: 'center', gap: 6 }}>
        <div style={{
          ...
          background: connected ? '#39d353' : '#e53e3e',
        }} />
        <span style={{ color: '#444', fontSize: 10 }}>{connected ? 'connected' : 'disconnected'}</span>
      </div>
    </div>
  )
}
